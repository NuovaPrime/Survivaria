...
namespace Survivaria.Items.BossItems
{
    ...
    {
        public TubofSlime() : base("Tub of Slime", "A barrel filled to the brim with royal gel.", 28, 26, Item.buyPrice(0, 1, 0, 0), ItemRarityID.Green, 72, 0, SoundID.Item28, SurvivariaMod.Instance.BuffType<GellifiedBuff>(), 10800, 1)
        {
        }
