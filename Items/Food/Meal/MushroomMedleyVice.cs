...
{
    public class MushroomMedleyVice : FoodItem
    {
        public MushroomMedleyVice() : base("Mushroom Medley", "When you mix all kinds of stuff, it becomes a stuffed mix.", 24, 30, Item.buyPrice(0, 0, 40, 0), ItemRarityID.Green, 26, 2, SoundID.Item2, BuffID.Shine, 60 * 180)
        {
        }
