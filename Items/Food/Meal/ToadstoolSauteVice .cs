...
namespace Survivaria.Items.Food.Meal
{
    ...
    {
        public ToadstoolSauteVice() : base("Toadstool Sauté", "It gives off a slightly bad vibe, maybe you shouldn't eat it.", 24, 30, Item.buyPrice(0, 0, 40, 0), ItemRarityID.Green, 24, 0, SoundID.Item2, BuffID.Bewitched, 60 * 180)
        {
        }
